...
<?$APPLICATION->IncludeFile("/sveden/eduStandarts/eduFed.html",Array(),Array("MODE"=>"html"));?><br>
</div>
...
<br><h3>Информация о самостоятельно устанавливаемых требованиях, с размещением их в форме электронного документа, подписанного электронной подписью </h3>
