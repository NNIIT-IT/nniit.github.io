...
if(count($this->listitems)==0){
		...
		$html.="<tr itemprop=\"eduChislen\" class=\"maindocselementHB\" id=\"row01\" data-id=\"0\" data-iblock=\"8\" title=\" \">\r\n";
		$html.="<td itemprop=\"eduCode\" rowspan=\"3\">{$item["code"]}</td>\r\n";
		$html.="<td rowspan=\"3\" ><span itemprop=\"eduName\" >".$this::emptyCell."</span><br><span itemprop=\"eduProfile\">".$this::emptyCell."</span></td>\r\n";
		$html.="<td itemprop=\"eduLevel\" class=\"hide\">".$this::emptyCell."</td>\r\n";
		$html.="<td itemprop=\"eduForm\">Очная</td>\r\n";
		...
		$html.="<tr itemprop=\"eduChislen\" class=\"maindocselementHB\" id=\"row02\" data-id=\"0\" data-iblock=\"8\" title=\" \">\r\n";
		$html.="<td itemprop=\"eduCode\" class=\"hide\">{$item["code"]}</td>\r\n";
		$html.="<td><span itemprop=\"eduName\" class=\"hide\">".$this::emptyCell."</span><br><span itemprop=\"eduProfile\">".$this::emptyCell."</span></td>\r\n";
		$html.="<td itemprop=\"eduLevel\" class=\"hide\">".$this::emptyCell."</td>\r\n";
		$html.="<td itemprop=\"eduForm\">Заочная</td>\r\n";
		$html.="<td><span itemprop=\"numberBF\">0</span> / <span itemprop=\"numberBFF\">0</span></td>\r\n";
		$html.="<td><span itemprop=\"numberBR\">0</span> / <span itemprop=\"numberBRF\">0</span></td>\r\n";
		$html.="<td><span itemprop=\"numberBM\">0</span> / <span itemprop=\"numberBMF\">0</span></td>\r\n";
		$html.="<td><span itemprop=\"numberP\">0</span> / <span itemprop=\"numberPF\">0</span></td>\r\n";
		...
		$html.="<tr itemprop=\"eduChislen\" class=\"maindocselementHB\" id=\"row03\" data-id=\"0\" data-iblock=\"8\" title=\" \">\r\n";
		$html.="<td itemprop=\"eduCode\" class=\"hide\">{$item["code"]}</td>\r\n";
		$html.="<td><span itemprop=\"eduName\" class=\"hide\">".$this::emptyCell."</span><br><span itemprop=\"eduProfile\">".$this::emptyCell."</span></td>\r\n";
		$html.="<td itemprop=\"eduLevel\" class=\"hide\">".$this::emptyCell."</td>\r\n";
		$html.="<td itemprop=\"eduForm\">Очно-заочная</td>\r\n";
		$html.="<td><span itemprop=\"numberBF\">0</span> / <span itemprop=\"numberBFF\">0</span></td>\r\n";
		$html.="<td><span itemprop=\"numberBR\">0</span> / <span itemprop=\"numberBRF\">0</span></td>\r\n";
		$html.="<td><span itemprop=\"numberBM\">0</span> / <span itemprop=\"numberBMF\">0</span></td>\r\n";
		$html.="<td><span itemprop=\"numberP\">0</span> / <span itemprop=\"numberPF\">0</span></td>\r\n";
